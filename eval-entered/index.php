...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-padding-xxlarge w3-text-white w3-text-shadow">
    
	<div class="w3-center">
    <span class="w3-large w3-center">
	</br>
	</br>
	<span class="w3-jumbo w3-hide-small">Thanks!</span><br>
	<i>Your evaluation has been entered.</i></span>
	</br>
	</br>
    <p><a href="../add-eval" class="w3-btn w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Submit Another Evaluation</a></p>
	<p><a href="../" class="w3-btn w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Return to Homepage</a></p>
	</div>
  </div>
</header>
